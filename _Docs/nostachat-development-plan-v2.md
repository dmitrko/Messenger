...
- [ ] Генерация UIN (ICQ-style: 6-9 цифр)
- [ ] Contact list: online пользователи
- [ ] Direct message: отправка конкретному UIN
- [ ] "Твой UIN: 482736 — поделись с другом"

**Результат**: Приватный мессенджер без привязки к телефону
...
**Результат ИТЕРАЦИИ 3**: P2P + E2E с пост-квантовым шифрованием
...
**Результат ИТЕРАЦИИ 4**: ICQ-дух, buzz, разделённые секции контактов
