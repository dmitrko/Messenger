...
async function loadCrypto() {
  ...
  try {
    const { webcrypto } = await import("./crypto-6BIXS4VN.js");
    return webcrypto;
  } catch (_e) {
...
// ../../node_modules/crystals-kyber-js/esm/src/mlKem512Base.js
var MlKem512Base = class extends MlKemBase {
  constructor() {
    super();
    Object.defineProperty(this, "_k", {
      enumerable: true,
  ...
  _sampleNoise1(sigma, offset, size) {
    ...
    for (let i = 0; i < size; i++) {
      r[i] = this._noiseVecs[offset + i];
      byteopsCbd2(r[i], this._prf1(sigma, offset + i), this._eta1);
    }
    return r;
  }
};
function byteopsCbd2(out, buf, eta) {
  let t, d;
  let a, b;
  for (let i = 0; i < N / 4; i++) {
...
var MlKem512 = class extends MlKem512Base {
  /**
...
// ../../node_modules/crystals-kyber-js/esm/src/mlKem512Impl.js
var MlKem512Impl = class _MlKem512Impl extends MlKem512Base {
  constructor() {
    super();
  }
  /** Generates a keypair [publicKey, privateKey]. */
...
// ../../node_modules/crystals-kyber-js/esm/src/mlKem768Impl.js
var MlKem768Impl = class _MlKem768Impl extends MlKemBase {
  constructor() {
    super();
    Object.defineProperty(this, "_k", {
      enumerable: true,
...
// ../../node_modules/crystals-kyber-js/esm/src/mlKem1024Base.js
var MlKem1024Base = class extends MlKemBase {
  constructor() {
    super();
    Object.defineProperty(this, "_k", {
      enumerable: true,
  ...
  _compressU(r, u) {
    ...
    for (let rr = 0, i = 0; i < this._k; i++) {
      for (let j = 0; j < N / 8; j++) {
        for (let k = 0; k < 8; k++) {
          t[k] = uint16(((uint32(u[i][8 * j + k]) << 11) + uint32(Q / 2)) / uint32(Q) & 2047);
        }
        r[rr++] = byte(t[0] >> 0);
...
var MlKem1024 = class extends MlKem1024Base {
  /**
...
// ../../node_modules/crystals-kyber-js/esm/src/mlKem1024Impl.js
var MlKem1024Impl = class _MlKem1024Impl extends MlKem1024Base {
  constructor() {
    super();
  }
  /** Generates a keypair [publicKey, privateKey]. */
...
crystals-kyber-js/esm/src/sha3/utils.js:
  (*! noble-hashes - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=crystals-kyber-js.js.map
